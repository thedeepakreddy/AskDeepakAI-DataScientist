        ...
        <div className="flex items-center gap-5">
          {activeDataset && (
            <div className="hidden sm:flex items-center gap-2 bg-black/20 backdrop-blur-md border border-white/5 px-4 py-1.5 rounded-full shadow-[inset_0_1px_8px_rgba(255,255,255,0.02)] text-xs">
              <span className="w-1.5 h-1.5 bg-indigo-400 rounded-full animate-pulse shadow-[0_0_12px_rgba(99,102,241,0.8)]"></span>
              <span className="text-indigo-300 font-mono text-[11px] font-semibold">{activeDataset.filename}</span>
              <span className="text-slate-600 font-mono">/</span>
              <span className="text-slate-400 font-medium font-mono text-[11px] opacity-80">{activeDataset.rowCount.toLocaleString()} units</span>
            </div>
          )}
